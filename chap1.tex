...
% --------------------------fig
\begin{figure}[h!] \centering \includegraphics[width=1.0\textwidth]{fig1_01}
...
(Figure 3A, Table \ref{tab:kinetics-result}). In contrast, at
...
activity reduction after seven days (Figure \ref{fig:kinetics-fig}, Table 2).
Remarkably, \emph{p}FF-F104A retained 66\% activity after seven days. The
non-fluorinated counterpart F104A failed to exhibit activity after one day.
Together these data confirm that \emph{p}FF-F104A is able to delay heat
inactivation while maintaining function after one week.

% --------------------------
\begin{figure}[h!] \centering \includegraphics[width=1.0\textwidth]{fig1_08}
    \caption[(A) Residual activity (RA) profile of all proteins, (B) Activity
    measured as a function of days.]{(A) Residual activity (RA) profile of all
