...
\begin{figure}[htbp] \centering \includegraphics[width=0.8\textwidth]{fig1_15}
...
protein–protein interactions \cite{Selzer2000,Reina2002}. Selzer \latin{et al.}
...
Willcox \latin{et al.} revealed the binding between HLA-A2 and LIR-1, a host
...
Using Rosetta, Jiang \latin{et al.} further design retro-aldolases with four
...
ability to bind metals - \ce{Zn^{2+}}, \ce{Co^{2+}}, \ce{Ni^{2+}}, and
\ce{Fe^{2+}} - with high affinity. (Figure \ref{fig:rosetta-uaa}) 
% -------------------------- fig-rosetta-uaa
...
protein. Steiner \latin{et al.} analyzed fluorinated Pro ((4R)-FPro and
...
\ref{fig:rosetta-pte}).  
% --------------------------
\begin{figure}[h!] \centering \includegraphics[width=0.7\textwidth]{fig1_30}
