...
% --------------------------
\begin{figure}[h!] \centering \includegraphics[width=0.9\textwidth]{f_1_24}
...
groups.\cite{Kar2009,Stahl2010a,Fletcher2012} Yu \latin{et al.} have developed
...
helical assembly of CMPs. Woolfson \latin{et al.} have alternatively developed
\latin{de novo} basis set sequences of ${\alpha}$-helical peptides based on precedent
...
can be ordained from natural protein sequences, with which \latin{de novo}
...
\latin{Drosophila} CG15920 gene.\cite{Ardell2001} Rauscher committed post-hoc
...
% --------------------------
\begin{figure}[h!] \centering \includegraphics[width=0.7\textwidth]{f_1_26}
...
{Model of silk processing of \latin{B.mori} silk, demonstrating how macroscopic
...
of the \latin{Bombyx} fibroins are characterized by the dipeptide units GA, GS,
...
% --------------------------
\begin{figure}[h!] \centering \includegraphics[width=0.8\textwidth]{f_1_28}
    \caption[(A) Schematic representation of purification method based on the
        ...
        calmodulin, producing a reversible \ch{Ca^2+}-induced self-assembly and
        phase separation. (C) Intein-elastin-like peptide tag as an
        auto-cleavable purification tag. (D) \ch{Ca^2+}-induced purification
        method based on phase separation of recombinant constructs, using a
    \ch{Ca^2+}-sensitive CyaA repeat-in-toxin domain.]{(A) Schematic
            ...
            \ch{Ca^2+}-induced self-assembly and phase separation.\cite{Kim2008a}
            (C) Intein-elastin-like peptide tag as an auto-cleavable
            purification tag.\cite{Banki2005} (D) \ch{Ca^2+}-induced purification
            method based on phase separation of recombinant constructs, using a
            \ch{Ca^2+}-sensitive CyaA repeat-in-toxin domain.\cite{Shur2013}}
...
Wood \latin{et al.} have adapted intein-based cleavage host-domains, previously
...
Banta \latin{et al.} have adapted the unexpected
...
their physicochemical properties by Montclare \latin{et
al.}.\cite{Haghpanah2010,Haghpanah2009} These copolymers were generated as a
...
codon with a non-natural amino acid - \iupac{\ortho-methyl-\L-tyrosine}. The
...
drastically from the \latin{in vitro}-based methods employed years earlier and
...
site-directed mutagenesis and \latin{in vivo} selection methods for tRNA and
...
host, such as \latin{E.coli}, that also expresses the modified tRNA and
...
suppression allowing for the successful \latin{in vivo} translation of
quadruplet codons. This has been recently accomplished by Chin \latin{et al.} by
...
\iupac{\para-azido-\L-phenylalanine} and
\iupac{\N6-[(2-propynyloxy)carbonyl]-\L-lysine} - into a
recombinant GST-calmodulin protein.

% --------------------------
\begin{figure}[h!] \centering \includegraphics[width=0.9\textwidth]{f_1_27}
    \caption[Site-specific incorporation using orthogonal tRNA and synthetase
        pair specific for the non-natural amino acid. A completely \latin{in
        vivo} system, (A) tRNA modification is accomplished via site-directed
        mutagenesis, and (B) aminoacyl-tRNA synthetase modification via
        \latin{in vitro} selection. Expression is conventionally carried out in
        \latin{E.coli}.]{Site-specific incorporation using orthogonal tRNA and synthetase
        pair specific for the non-natural amino acid. A completely \latin{in
        vivo} system, (A) tRNA modification is accomplished via site-directed
        mutagenesis, and (B) aminoacyl-tRNA synthetase modification via
        \latin{in vitro} selection. Expression is conventionally carried out in
        \latin{E.coli}.\cite{Yoder2002}}
...
existence of auxotrophic expression hosts.\cite{Link2003,Link2005} Tirrell \latin{et al.}
have employed \latin{E.  coli} auxotrophic strains for Met,\cite{Kiick2002}
Ile,\cite{Wang2003a}
Val,\cite{Wang2004}
Phe,\cite{Yoshikawa1994} 
and Leu residues,\cite{Tang2001a}
allowing for the possibility for downstream incorporation efforts,
such as the incorporation of both \iupac{(2\S,3\R)-4,4,4-trifluorovaline} and
...
% --------------------------
\begin{figure}[h!] \centering \includegraphics[width=0.7\textwidth]{f_1_29}
    \caption[\latin{In vivo} usage of the degenerate codons by way of
    an orthogonal yeast-derived tRNA\textsuperscript{Phe}/phenylalanyl-tRNA
    synthetase pair. This example by Tirrell \latin{et al.} is for the
introduction of phenylalanine in response to UUC codons and naphthylalanine in
response to UUU codons.]{\latin{In vivo} usage of the degenerate codons by way of
    an orthogonal yeast-derived tRNA\textsuperscript{Phe}/phenylalanyl-tRNA
    synthetase pair. This example by Tirrell \latin{et al.} is for the
introduction of phenylalanine in response to UUC codons and naphthylalanine in
...
encode for \iupac{2-naphthylalanine}, thus demonstrating the potential for
...
\latin{E.coli} charging. This vein of method development, utilizing degenerate
...
thiaproline [\iupac{1,3-thiazolidine-4-carboxylic acid}], which belongs to the
group of pseudo-prolines on oxazolidine and thiazolidine bases, by way of
residue-specific incorporation using a proline-auxotrophic \latin{E.coli} DSM
...
order to probe the conserved axial methionine from \latin{Pseudomonas
aeruginosa} azurin, partially defining the blue copper center
...
\begin{figure}[h!] \centering \includegraphics[width=0.7\textwidth]{f_1_19}
    \caption[Examples of incorporation of fluorinated, non-natural amino acids
        ...
        % --------------------------
        (C) Structural stability of a \latin{de novo} coiled-coil by way
        of incorporation of \iupac{hexafluoro-\L-leucine} into the hydrophobic
...
modified tRNA-synthetase to ultimately study \latin{E.coli} proteins via
...
\iupac{3-fluoro-tyrosine} and \iupac{trifluoromethyl-\L-phenylalanine} into
...
work by Lee, in which a \latin{de novo} anti-parallel tetrameric coiled-coil -
...
motif positions, with hexafluoroleucine resulting in an overall ${\Delta \Delta
    ...
    partitioning of the fluorinated side chain from \iupac{n-heptanol} into
    water.
...
oxide-based contrast agents, and \ch{Gd^3+}- and \ch{Mn^2+}-based contrast
...
fluorinated amino acid, \iupac{\para-fluorophenylalanine} (\emph{p}FF), into
...
while I am writing my article. Specifically, I would like to see if 
...
\SI{5}{\milli\moLar} \ch{MgSO4}, with a volumetric equivalent to that of the
...
\ch{CO(NH2)2} (urea), \pH 8.0. The pellet was resuspended in a 4:70 volumetric ratio
...
FastFlow column (GE Life Sciences), charged with \ch{CoCl2}, using an \"{A}KTA
...
phosphate buffer, \pH 8.0. The absorbance at \SI{350}{\nm} was measured as each
...
\iupac{poly-\L-lysine} by Greenfield.\cite{Greenfield1969} The method of
...
% --------------------------
% Also discuss and reference the paper on mesophase separation.
...
\begin{figure}[h!]
    \centering
    \begin{subfigure}[b]{0.32\textwidth}
        \includegraphics[width=\textwidth]{f_1_14_7}
        \caption{}
        \label{fig:thermo_ECpFF}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\textwidth}
        \includegraphics[width=\textwidth]{f_1_14_8}
        \caption{}
        \label{fig:thermo_CEpFF}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\textwidth}
        \includegraphics[width=\textwidth]{f_1_14_9}
        \caption{}
...
\begin{figure}
    ...
    \begin{subfigure}[b]{0.47\textwidth}
        \includegraphics[width=\textwidth]{f_1_25_1}
        \caption{}
        \label{fig:brightfield_ECE_2.5}
    \end{subfigure}
    \begin{subfigure}[b]{0.47\textwidth}
        \includegraphics[width=\textwidth]{f_1_25_2}
        \caption{}
