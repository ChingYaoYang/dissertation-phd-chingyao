...
is site-directed mutagenesis (SDM)\cite{Arnold1993}. With
...
\ref{fig:sdm-1})\cite{Ho1989}. Upon the first polymerase chain reaction, two
...
codon - are formed. DNA polymerase is then used for second PCR to amplify the
desired DNA\cite{Ho1989}. 
% -------------------------- fig-sdm-1
...
replicated. After PCR products are collected. DpnI methylase is used for digestion
in order to the mutant gene.  Upon transformation into competent cells, a circular, mutated
plasmid DNA is then obtained\cite{Antikainen2005a}. (Figure \ref{fig:sdm-2})
% -------------------------- fig-sdm-2
