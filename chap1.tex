...
Kazlauskas \latin{et al.} focused on engineering fluorescent proteins based on protein
...
when the structure and mechanism are well-known. Quillin \latin{et al.} has adapted
...
proteins \cite{Leaver-Fay2011}. Baker \latin{et al.} adapted this suite for
...
ions, \ch{Mn^{2+}}, \ch{Co^{2+}}, \ch{Ni^{2+}}, \ch{Cd^{2+}}, or \ch{Zn^{2+}}
