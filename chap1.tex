...
\begin{figure}[h!] \centering \includegraphics[width=0.55\textwidth]{fig1_12}
...
% -------------------------- fig*
% -------------------------- beta-turn
\begin{figure}[h!] \centering \includegraphics[width=0.55\textwidth]{fig1_29}
...
Sheridan \latin{et al.} further quantified the destabilized array of parallel
helices of \SI{83.6}{\joule\per\mol} \cite{Sheridan1982}.

Proteins are essential to cell function and metabolism
\cite{Lambert2012,Horton2007,Dessein2008}. Recently, Proprotein convertase
subtilisin/kexin type 9 (PCSK9), one of the serine endoproteases, was found to
regulate low density lipoprotein (LDL) in liver
...
One of well-known protein roles is as an enzyme. Enzymes mediate chemical
...
\SI{5e-24}{\Molar} \cite{Radzicka1995}.
...
Using Rosetta, Jiang \latin{et al.} design retro-aldolases with four different
...
% -------------------------- fig-rosetta-enzyme
\begin{figure}[h!] \centering \includegraphics[width=1.0\textwidth]{fig1_23}
...
\latin{et al.} use \emph{RosettaMatch} package from Rosetta packages to design
...
protein with the ability to bind metals - \ce{Zn^{2+}}, \ce{Co^{2+}},
\ce{Ni^{2+}}, and \ce{Fe^{2+}} - with high affinity. (Figure \ref{fig:rosetta-uaa})
% -------------------------- fig-rosetta-uaa
...
manner, Jackson \latin{et al.} incorporated several Phe analogs -
...
% --------------------------
\begin{figure}[h!] \centering \includegraphics[width=0.6\textwidth]{fig1_24}
...
molecules ave been developed for enabling the \latin{in vivo} manipulation of
...
interactions for identification of involved region. Chin \latin{et al.} use an
...
\latin{in vitro} site-specific incorporation\cite{Cellitti2008,Hassan2008}, and
...
% --------------------------fig-epl
\begin{figure}[h!] \centering \includegraphics[width=0.5\textwidth]{fig1_25}
...
% --------------------------fig-spps
\begin{figure}[h!] \centering \includegraphics[width=0.5\textwidth]{fig1_26}
...
\latin{et al.} have developed a general approach for the \latin{in vitro}
...
% --------------------------fig-ncl
\begin{figure}[h!] \centering \includegraphics[width=0.5\textwidth]{fig1_10}
...
% --------------------------fig*
% --------------------------fig-ssi
\begin{figure}[h!] \centering \includegraphics[width=0.8\textwidth]{fig1_09}
...
% -------------------------- fig-rsi
\begin{figure}[h!] \centering \includegraphics[width=0.8\textwidth]{fig1_03} 
...
water\cite{Lewis1988}.  Aubert \latin{et al.} then proposes catalytic mechanism
...
% --------------------------fig-pte-mechanism
\begin{figure}[h!] \centering \includegraphics[width=0.6\textwidth]{fig1_27}
...
\ref{fig:PJB})
% --------------------------fig-PJB
\begin{figure}[h!] \centering \includegraphics[width=0.4\textwidth]{fig1_28}
