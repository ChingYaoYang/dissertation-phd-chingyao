...
Budisa group showed that enzymes change the specificities with the incorporation of unnatural amino acids\cite{Budisa2006}. 
% --------------------------end of new
...
In SPPS, activated amino acids are
...
active site. \ch{Mn^{2+}}, \ch{Co6{2+}}, \ch{Ni^{2+}}, \ch{Cd^{2+}},
