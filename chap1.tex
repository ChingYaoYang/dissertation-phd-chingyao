...
\begin{figure}[htbp] 
    \centering \includegraphics[width=0.55\textwidth]{fig1_12}
...
% -------------------------- fig*
% -------------------------- beta-turn
\begin{figure}[p] \centering \includegraphics[width=0.55\textwidth]{fig1_29}
...
% weight of
% an \emph{Escherichia coli} cell\cite{Neidhardt1990}. 
...
the case of decarboxylase \cite{Radzicka1995a}. Radzicka \latin{et al.}
...
Kazlauskas \latin{et al.} focused a selection of single mutations that enhanced
...
\begin{figure}[htbp] \centering \includegraphics[width=0.6\textwidth]{fig1_15}
...
% -------------------------- fig-CPD
\begin{figure}[htbp] \centering \includegraphics[width=0.6\textwidth]{fig1_18}
...
tools assist the developments of rational design. Otten \latin{et al.} and
Moss \latin{et al.} demonstrate that the algorithms alter enzymes activity
...
\cite{Selzer2000,Reina2002}.  Selzer \latin{et al.} engineer the protein TEM1
...
(Figure\ref{fig:tem1})
% -------------------------- fig-tem1
\begin{figure}[htbp] \centering \includegraphics[width=0.6\textwidth]{fig1_19}
...
% -------------------------- fig-protein-engineering
\begin{figure}[p] \centering \includegraphics[width=0.8\textwidth]{fig1_20}
...
Later, Chaudhury \latin{et al.} demonstrated the use of Rosetta on the
...
\begin{figure}[p] \centering \includegraphics[width=0.8\textwidth]{fig1_21}
...
protein environment\cite{Renfrew2012b}. Mills \latin{et al.} use
...
bind metals - \ce{Zn^{2+}}, \ce{Co^{2+}}, \ce{Ni^{2+}}, and \ce{Fe^{2+}} - with
high affinity. (Figure \ref{fig:rosetta-uaa})
% -------------------------- fig-rosetta-uaa
\begin{figure}[p] \centering \includegraphics[width=1.0\textwidth]{fig1_23}
...
Jackson \latin{et al.} incorporated several Phe analogs -
...
% --------------------------
\begin{figure}[p] \centering \includegraphics[width=0.6\textwidth]{fig1_24}
...
each approach.
% --------------------------fig-epl
\begin{figure}[h!] \centering \includegraphics[width=0.7\textwidth]{fig1_25}
...
\subsubsection{\latin{in vivo} Site-specific Incorporation}
...
\subsubsection{\latin{in vivo} Residue-specific Incorporation}
...
\latin{et al.} showed that the most active PTE contained \ch{Co^{+}} metal ions
in the active site \cite{Omburo1992a}. From the spectrum of \ch{^{113}Cd}-NMR,
...
\latin{et al.} then proposes catalytic mechanism of PTE\cite{Aubert2004}.
...
and an complex forms as a phosphate anion that bridges the two \ch{Zn^{2+}}.The
...
\ref{fig:rosetta-pte}).  
% --------------------------
\begin{figure}[h!] \centering \includegraphics[width=1.0\textwidth]{fig1_30}
...
\latin{et al.} previously replaced all Phe positions with \emph{p}FF, which led
