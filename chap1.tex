...
% go through PE intro, ways proteins are engineered.
% --------------------------new
...
functionalities and metabolism. 

Enzyme, one of the forms of proteins, mediates chemical reactions and serves
different functions in agricultures and pharmaceutical industries. The
enzyme-catalyzed reactions were initially studied in the 19th
century\cite{AthelCornish-Bowden2012}. Compared to the chemical catalysts,
...
used for synthesis of polypeptide chain.  
% --------------------------end of new

\subsubsection{Rational Design}

% add site-directed mutagenesis based on structure. (natural aa)
% add computational methods here
% --------------------------new
Back to 70s, rational design was used to design new protein molecules with
goals of designing novel functions. With improvements of technologies, such as
structural bio-informatics, the developments of rational design are speeded up.
The conventional methodologies for rational designs include peptide synthesis,
gene synthesis, or site-directed mutagenesis (SDM).
...
(Figure \ref{fig:rsi})\cite{Johnson2010}. 
In SPPS, activated amino acids are immobilized on a solid support and
...
77\% final yield.  To synthesis longer chain peptides and proteins bearing
UAAs, biosynthetic methods have been developed.  There exists three
contemporary methods to biosynthetically incorporate non-natural amino acids
into proteins: site-specific incorporation (SSI), residue-specific
...
chemically charged with the amino acid analog. This method has been well
studied and developed in research of protein structures and
