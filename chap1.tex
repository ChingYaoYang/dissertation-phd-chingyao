...
\end{equation}
1/v = (KM/VMax) * (1/[S]) + 1/VMax S2 where [S] represents substrate concentration; KM
represents the substrate concentration at which the reaction rate is half of
Vmax. The data reported is the average of three trials and the error represents
the standard deviation of those trials.
