...
food precessing\cite{Wiseman1993}. The regular protein engineering methods are listed in Table \ref{tab:protein-engineering}.
...
\begin{table}[h!]
    ...
    \begin{tabular}{ ll }
        ...
        Rational design & \cite{Arnold1993} \\
        Site-directed mutagenesis & \cite{Antikainen2005} \\
        Random mutagenesis & \cite{Mehta2011b} \\
        DNA shuffling & \cite{Haroon2003,Siren2001} \\
        Molecular dynamics & \cite{Bella1995} \\
        Peptidomimetics & \cite{Green1999} \\
        Phage display technology & \cite{Crawford2014} \\
        \emph{De novo} enzyme engineering & \cite{Kirk2002} \\
        Flow cytometry & \cite{Berg2002} \\ 
